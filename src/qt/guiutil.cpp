...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("digitalgold://"))
    {
        uri.replace(0, 11, "digitalgold:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Digitalgold-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  digitalgold-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Digitalgold-Qt"));
