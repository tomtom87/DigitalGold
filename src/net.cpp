...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Digitalgold " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"digitalgold.ddns.net", "50.35.121.181"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"digitalgoldtools.com", "testnet-seed.digitalgoldtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Digitalgold is probably already running."), addrBind.ToString().c_str());
        else
